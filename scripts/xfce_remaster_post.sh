...
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/kogaion-forensic.png "${CHROOT_DIR}/usr/share/backgrounds/kogaionlinux.png"
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/kogaion-forensic.jpg "${CHROOT_DIR}/usr/share/backgrounds/kogaionlinux.jpg"
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/kogaion-forensic.jpg "${CHROOT_DIR}/usr/share/themes/Adwaita/backgrounds/stripes.jpg"
