...
GFORENSIC_DIR="/rogentos/remaster/gforensic"
# setup skel and background
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/rogentos-forensic.png "${CHROOT_DIR}/usr/share/backgrounds/rogentoslinux.png"
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/rogentos-forensic.jpg "${CHROOT_DIR}/usr/share/backgrounds/rogentoslinux.jpg"
cp "${GFORENSIC_DIR}"/usr/share/backgrounds/rogentos-forensic.jpg "${CHROOT_DIR}/usr/share/themes/Adwaita/backgrounds/stripes.jpg"
