...
%env %import ${SABAYON_MOLECULE_HOME:-/kogaion}/molecules/gaming.common
...
%env source_iso: ${SABAYON_MOLECULE_HOME:-/kogaion}/iso/Sabayon_Linux_${ISO_TAG:-DAILY}_x86_G.iso
