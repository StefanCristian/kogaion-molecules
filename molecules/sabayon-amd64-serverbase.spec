...
%env %import ${ROGENTOS_MOLECULE_HOME:-/sabayon}/molecules/serverbase.common
...
%env destination_iso_image_name: Sabayon_Linux_${ROGENTOS_RELEASE:-2}_amd64_ServerBase.iso
